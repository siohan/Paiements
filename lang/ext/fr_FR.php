...
$lang['friendlyname'] = 'Asso Paiements';
$lang['resultsfoundtext'] = 'Résultats trouvés';
$lang['moddescription'] = 'Gestion des paiements.';
$lang['welcome_text'] = '<p>Bienvenue dans le module de gestion des paiements</p>';
...
<p>Ce module vous permet de gérer les paiements (cotisations, achats boutique de l\'asso etc,.. et de gérer les relances éventuelles. Ceci n\'est pas encore un logiciel de compta à proprement parler.</p>
<ul>
<li>Pour obtenir la dernière version en cours (avant release officielle)
<a href="https://github.com/siohan/paiements">Version github</a>.</li>
